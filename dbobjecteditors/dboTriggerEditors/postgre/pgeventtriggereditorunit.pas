...
implementation
uses pg_sql_lines_unit, fbmStrConstUnit, fbmToolsUnit, pg_SqlParserUnit, ibmSqlUtilsUnit, LazUTF8,
  strutils, PGKeywordsUnit;
  ...
  begin
    ...
    if not Sg.SystemObject then
      ...
      begin
        ...
        if P.ReturnTypeOID = TSQLEnginePostgre(DBObject.OwnerDB).IDEventTriggerType then
        begin
