...
resourcestring
  ...
  sGenerateType                     = 'Generate type';
  sGenerateSQLScript                = 'Generate SQL script';
  sInsertIntoTable                  = 'Insert into table';
  sRecordsToGenerated               = 'Records to generated';
  sCommitAfter                      = 'Commit after';
  sDataGeneratorType                = 'Data generator type';
  sGenerateRandomly                 = 'Generate randomly';
  sGetFromAnotherTable              = 'Get from another table';
  sGetFromList                      = 'Get from list';
  sGetFromTable                     = 'Get from table';
  sTimeConstraint                   = 'Time constraint';
  sMinTime                          = 'Min. time';
  sMaxTime                          = 'Max. time';
  sNumberOfRecords                  = 'Number of records';
  sStringConstraints                = 'String constraints';
  sGenerateGUID                     = 'Generate GUID';
  sMinLength                        = 'Min. length';
  sMaxLength                        = 'Max. length';
  sNumericConstraints               = 'Numeric constraints';
  sIntegerConstarints               = 'Integer constarints';
