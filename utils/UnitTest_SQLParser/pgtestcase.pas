...
type
  ...
  published
    ...
    procedure c482CreateTable35;
    procedure c483CreateTable36;
    procedure c484AlterTable6;
    procedure c485AlterTable7;
    procedure c486AlterTable8;
...
procedure TPGSQLParserTest.c470SQLGrant5;
begin
  DoTestSQL(PGSQLParserData.sUserAcess['Grant5']);
end;

procedure TPGSQLParserTest.c471SQLGrant6;
begin
  DoTestSQL(PGSQLParserData.sUserAcess['Grant6']);
end;
...
procedure TPGSQLParserTest.c476SQLGrant8;
begin
  DoTestSQL(PGSQLParserData.sUserAcess['Grant8']);
end;

procedure TPGSQLParserTest.c477SQLGrant9;
begin
  DoTestSQL(PGSQLParserData.sUserAcess['Grant9']);
end;
...
procedure TPGSQLParserTest.c482CreateTable35;
begin
  DoTestSQL(PGSQLParserData.sTable['CreateTable35']);
end;

procedure TPGSQLParserTest.c483CreateTable36;
begin
  DoTestSQL(PGSQLParserData.sTable['CreateTable36']);
end;

procedure TPGSQLParserTest.c484AlterTable6;
begin
  DoTestSQL(PGSQLParserData.sTable['AlterTable6']);
end;

procedure TPGSQLParserTest.c485AlterTable7;
begin
  DoTestSQL(PGSQLParserData.sTable['AlterTable7']);
end;

procedure TPGSQLParserTest.c486AlterTable8;
begin
  DoTestSQL(PGSQLParserData.sTable['AlterTable8']);
end;

procedure TPGSQLParserTest.c487CreateTable37;
begin
  DoTestSQL(PGSQLParserData.sTable['CreateTable37']);
end;

procedure TPGSQLParserTest.c489CreateTable38;
begin
  DoTestSQL(PGSQLParserData.sTable['CreateTable38']);
end;
